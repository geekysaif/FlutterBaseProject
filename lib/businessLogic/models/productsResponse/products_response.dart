...
abstract class ProductsResponse implements Built<ProductsResponse, ProductsResponseBuilder> {
  ...
  factory ProductsResponse([Function(ProductsResponseBuilder b) updates]) = _$ProductsResponse;


  @BuiltValueField(wireName: 'products')
  BuiltList<ProductsDto>? get products;
  ...
  String toJson() {
    return jsonEncode(serializers.serializeWith(ProductsResponse.serializer, this));
  }

  static ProductsResponse fromJson(String jsonString) {
    return serializers.deserializeWith(
        ProductsResponse.serializer, jsonDecode(jsonString))!.rebuild(
            (b) => b..products ??=  ListBuilder<ProductsDto>()
          ..total ??= 0
          ..skip ??= 0
          ..limit ??= 0
    );
  ...
  static List<ProductsResponse> fromListJson(String jsonString) {
    return jsonDecode(jsonString)
        .map<ProductsResponse>((e) => fromJson(jsonEncode(e)))
        .toList();
  }
...
abstract class ProductsDto implements Built<ProductsDto, ProductsDtoBuilder> {
  ...
  factory ProductsDto([Function(ProductsDtoBuilder b) updates]) = _$ProductsDto;
  ...
  BuiltList<ReviewsDto>? get reviews;
  ...
  String toJson() {
    return jsonEncode(serializers.serializeWith(ProductsDto.serializer, this));
  }

  static ProductsDto? fromJson(String jsonString) {
    return serializers.deserializeWith(
        ProductsDto.serializer, jsonDecode(jsonString));
  }

  static List<ProductsDto> fromListJson(String jsonString) {
    return jsonDecode(jsonString)
        .map<ProductsDto>((e) => fromJson(jsonEncode(e)))
        .toList();
  }
...
/// DimensionsDto
abstract class DimensionsDto implements Built<DimensionsDto, DimensionsDtoBuilder> {
  DimensionsDto._();

  factory DimensionsDto([Function(DimensionsDtoBuilder b) updates]) = _$DimensionsDto;
  ...
  String toJson() {
    return jsonEncode(serializers.serializeWith(DimensionsDto.serializer, this));
  }

  static DimensionsDto? fromJson(String jsonString) {
    return serializers.deserializeWith(
        DimensionsDto.serializer, jsonDecode(jsonString));
  }

  static List<DimensionsDto> fromListJson(String jsonString) {
    return jsonDecode(jsonString)
        .map<DimensionsDto>((e) => fromJson(jsonEncode(e)))
        .toList();
  }

  static Serializer<DimensionsDto> get serializer => _$dimensionsDtoSerializer;
}
...
abstract class ReviewsDto implements Built<ReviewsDto, ReviewsDtoBuilder> {
  ...
  factory ReviewsDto([Function(ReviewsDtoBuilder b) updates]) = _$ReviewsDto;
  ...
  String toJson() {
    return jsonEncode(serializers.serializeWith(ReviewsDto.serializer, this));
  }

  static ReviewsDto? fromJson(String jsonString) {
    return serializers.deserializeWith(
        ReviewsDto.serializer, jsonDecode(jsonString));
  }

  static List<ReviewsDto> fromListJson(String jsonString) {
    return jsonDecode(jsonString)
        .map<ReviewsDto>((e) => fromJson(jsonEncode(e)))
        .toList();
  }
...
abstract class MetaDto implements Built<MetaDto, MetaDtoBuilder> {
  ...
  factory MetaDto([Function(MetaDtoBuilder b) updates]) = _$MetaDto;
  ...
  static List<MetaDto> fromListJson(String jsonString) {
    return jsonDecode(jsonString)
        .map<MetaDto>((e) => fromJson(jsonEncode(e)))
        .toList();
  }
